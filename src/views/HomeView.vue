...
<template>
  <main>
    ...
    >
      ...
      >
        <span
          class="newsletter-section__quote-mark text-4xl leading-none font-serif md:text-5xl lg:text-6xl"
          aria-hidden="true"
          >"</span
        >

        <p
          class="newsletter-section__quote mx-auto mt-2 max-w-[280px] text-lg italic font-serif leading-relaxed [text-wrap:balance] sm:max-w-md sm:text-xl md:max-w-xl md:text-2xl lg:text-[1.75rem]"
        >
          Jewelry is not just an ornament, it is a story, a memory, a work of art.
        </p>

        <p
          class="newsletter-section__author mt-4 text-xs uppercase tracking-wider text-gold-300 md:mt-5 md:text-sm"
        >
      ...
      >
        ...
        <button
          ...
          class="newsletter-section__submit flex h-[46px] w-[46px] shrink-0 items-center justify-center bg-gold-600 text-black transition-colors hover:bg-gold-500 md:h-[50px] md:w-[50px]"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
